...
export function WebsiteDesignPortfolio() {
  return (
    <section className="overflow-hidden bg-[#171717] py-24 sm:py-28 lg:py-32" aria-labelledby="website-design-portfolio-heading">
      <style>{`
      ...
      <div className="mx-auto w-full max-w-container px-5 sm:px-6">
        <div className="mx-auto max-w-[43rem] text-center">
          <p className="type-eyebrow">Selected Website Projects</p>
          <h2 id="website-design-portfolio-heading" className="mt-4 text-[2.15rem] font-semibold leading-tight text-[#fffaf5] sm:text-[2.65rem] lg:text-[3.15rem]">
            Websites We&apos;ve Designed for Real Businesses.
          </h2>
          <p className="mx-auto mt-5 max-w-[43rem] text-base leading-7 text-[#e8dfd6] sm:text-lg sm:leading-8">
            Explore a selection of websites Laybrotech has designed for businesses and organisations across different industries.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto mt-14 flex w-full max-w-container justify-center px-5 sm:mt-16 sm:px-6">
        <Link className="group inline-flex items-center gap-2 text-sm font-bold text-[#ff7a2b] transition-colors duration-smooth hover:text-[#ffb07a]" to="/projects">
          View All Projects
