  ...
  return (
    <section className="bg-white px-5 py-20 sm:px-6 sm:py-24 lg:py-32" aria-labelledby="hosting-included-heading">
      <div className="mx-auto w-full max-w-container">
        ...
        <div className="mt-12 grid grid-cols-2 gap-x-6 gap-y-6 sm:mt-14 sm:gap-x-8 sm:gap-y-5 lg:mt-16 lg:grid-cols-5 lg:gap-x-10 lg:gap-y-0" aria-label="Included hosting features">
          {includedFeatures.map(({ title, Icon }) => (
            <div className="flex min-h-[7.5rem] flex-col items-start gap-3 border-b border-[#e5e1dc] pb-5 lg:min-h-[8.25rem] lg:items-center lg:border-b-0 lg:pb-0 lg:pt-8 lg:text-center lg:[&:nth-child(-n+5)]:border-b lg:[&:nth-child(-n+5)]:pb-8" key={title}>
